...
set_property "part" "xc7s50csga324-1" $obj
...
set_property verilog_define [list FPGA FPGA_FULL ARTYS7] [get_filesets sources_1]
...
#set_property verilog_define [list FPGA FPGA_FULL ARTYS7] $obj
